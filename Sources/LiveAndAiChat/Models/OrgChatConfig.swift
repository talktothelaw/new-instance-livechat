...
public struct OrgAppearanceColors: Codable, Equatable, Sendable {
    public var chatBackground: String? = nil
    public var headerBackground: String? = nil
    public var headerPrimaryText: String? = nil
    public var headerSecondaryText: String? = nil
    public var headerIcon: String? = nil
    public var closeButton: String? = nil
    public var receivedBubble: String? = nil
    public var receivedText: String? = nil
    public var receivedTimestamp: String? = nil
    public var sentBubble: String? = nil
    public var sentText: String? = nil
    public var sentTimestamp: String? = nil
    public var systemMessageText: String? = nil
    public var daySeparatorBackground: String? = nil
    public var daySeparatorText: String? = nil
    public var footerContainer: String? = nil
    public var chatInputBackground: String? = nil
    public var chatInputText: String? = nil
    public var chatInputPlaceholder: String? = nil
    public var chatInputBorder: String? = nil
    public var sendButtonBackground: String? = nil
    public var sendButtonIcon: String? = nil
    public var attachmentButton: String? = nil
    public var emojiButton: String? = nil
    public var typingIndicatorBackground: String? = nil
    public var typingIndicatorDot: String? = nil
    public var unreadBadgeBackground: String? = nil
    public var unreadBadgeText: String? = nil
    public var scrollToBottomButtonBackground: String? = nil
    public var scrollToBottomButtonIcon: String? = nil
    public var onlineStatus: String? = nil
    public var offlineStatus: String? = nil
